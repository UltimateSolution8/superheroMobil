...
export const strings: Record<LanguageCode, Dictionary> = {
  en: {
    ...
    'home.not_available': 'Live in Hyderabad - launching soon in your area.',
    'home.checking_area': 'Checking service availability near you…',
    'home.live_city_line': 'We are currently live in {city}.',
    'home.launching_soon_line': 'Launching soon in your area',
    ...
    'home.card_city_kicker': 'Hyderabad live',
    'home.card_city_title': 'Launching city-first',
    'home.card_city_sub': 'Service is currently live in Hyderabad and expanding quickly.',
    ...
    'buyer.hyderabad_only': 'Tasks are currently available only in Hyderabad. Please select a Hyderabad location.',
  ...
  hi: {
    ...
    'home.not_available': 'हैदराबाद में लाइव - आपके क्षेत्र में जल्द शुरू होगा।',
    'home.checking_area': 'आपके आसपास सेवा उपलब्धता जांच रहे हैं…',
    'home.live_city_line': 'फिलहाल हम {city} में लाइव हैं।',
    'home.launching_soon_line': 'आपके क्षेत्र में जल्द शुरू होगा',
    ...
    'home.card_city_kicker': 'हैदराबाद लाइव',
    'home.card_city_title': 'शहर-दर-शहर लॉन्च',
    'home.card_city_sub': 'सेवा फिलहाल हैदराबाद में लाइव है और तेजी से विस्तार हो रहा है।',
    ...
    'buyer.hyderabad_only': 'टास्क अभी केवल हैदराबाद में उपलब्ध हैं। कृपया हैदराबाद का स्थान चुनें।',
  ...
  te: {
    ...
    'home.not_available': 'హైదరాబాద్‌లో లైవ్ - మీ ప్రాంతంలో త్వరలో ప్రారంభం.',
    'home.checking_area': 'మీ ప్రాంతంలో సేవ అందుబాటు చూస్తున్నాం…',
    'home.live_city_line': 'ప్రస్తుతం మేము {city}లో లైవ్‌లో ఉన్నాం.',
    'home.launching_soon_line': 'మీ ప్రాంతంలో త్వరలో ప్రారంభం',
    ...
    'home.card_city_kicker': 'హైదరాబాద్ లైవ్',
    'home.card_city_title': 'సిటీ-ఫస్ట్ లాంచ్',
    'home.card_city_sub': 'సేవ ప్రస్తుతం హైదరాబాద్‌లో లైవ్‌లో ఉంది, త్వరలో మరిన్ని ప్రాంతాలకు విస్తరిస్తుంది.',
    ...
    'buyer.hyderabad_only': 'టాస్క్‌లు ప్రస్తుతం హైదరాబాద్‌లో మాత్రమే అందుబాటులో ఉన్నాయి. దయచేసి హైదరాబాద్ లొకేషన్ ఎంచుకోండి.',
