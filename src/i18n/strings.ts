...
export const strings: Record<LanguageCode, Dictionary> = {
  ...
  te: {
    ...
    'helper.kyc.video_capture_failed': 'వీడియో క్యాప్చర్ చేయలేకపోయాం.',
    'helper.kyc.video_requirements': 'వీడియో మరియు ఐడీ ఫ్రంట్ తప్పనిసరి.',
    'helper.kyc.status_failed': 'KYC స్థితి పొందలేకపోయాం.',
    'helper.video_kyc.title': 'వీడియో KYC',
    'helper.video_kyc.subtitle': 'చిన్న వీడియో (గరిష్టం 20 సెకండ్లు) రికార్డ్ చేసి ఐడీ చిత్రాలు అప్లోడ్ చేయండి.',
    'helper.video_kyc.doc_front': 'ఐడీ ముందుభాగం అప్లోడ్ చేయండి',
    'helper.video_kyc.doc_front_selected': 'ఐడీ ముందుభాగం ఎంపికైంది',
    'helper.video_kyc.doc_back': 'ఐడీ వెనుకభాగం అప్లోడ్ చేయండి',
    'helper.video_kyc.doc_back_selected': 'ఐడీ వెనుకభాగం ఎంపికైంది',
    'helper.video_kyc.capture_video': 'వీడియో రికార్డ్ చేయండి',
    'helper.video_kyc.video_selected': 'వీడియో ఎంపికైంది',
    'helper.video_kyc.submit': 'వీడియో KYC సమర్పించండి',
