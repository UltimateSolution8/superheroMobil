...
export const strings: Record<LanguageCode, Dictionary> = {
  en: {
    ...
    'tabs.tasks': 'Tasks',
    'tabs.learn': 'Learn',
    'home.trusted_line': "India's most trusted service app",
    'home.welcome': 'Welcome',
    'home.not_available': 'Not available in your area yet. We will be there soon.',
  ...
  hi: {
    ...
    'tabs.tasks': 'टास्क',
    'tabs.learn': 'लर्न',
    'home.trusted_line': 'भारत का सबसे भरोसेमंद सर्विस ऐप',
    'home.welcome': 'स्वागत है',
    'home.not_available': 'आपके क्षेत्र में अभी उपलब्ध नहीं है। हम जल्द आएंगे।',
  ...
  te: {
    ...
    'tabs.tasks': 'టాస్క్స్',
    'tabs.learn': 'లెర్న్',
    'home.trusted_line': 'భారతదేశంలో అత్యంత విశ్వసనీయ సేవా యాప్',
    'home.welcome': 'స్వాగతం',
    'home.not_available': 'మీ ప్రాంతంలో ఇంకా అందుబాటులో లేదు. త్వరలో అందిస్తాం.',
